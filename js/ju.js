...
var click_selector = casper.cli.get(3);
var sleep_time = parseInt(casper.cli.get(4)) * 1000;
var shop_type = casper.cli.get(5);
...
casper.then(function() {
    ...
    if (this.exists(click_selector)) {
        this.wait(10000, function(){
            this.click(click_selector);
        });
    }
});
